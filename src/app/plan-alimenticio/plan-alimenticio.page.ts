...
const BACKUP_RECIPES: Recipe[] = [
  {
    ...
    description: 'Una opcion practica con pollo, verduras frescas y tortilla integral.',
    calories: 0,
    proteinGrams: 0,
    carbsGrams: 0,
    fatGrams: 0,
    ingredients: [
      ...
      'Tomate',
      'Aguacate',
      'Yogurt natural o aderezo ligero',
    ],
    instructions: [
      'Calienta la tortilla unos segundos.',
      'Coloca el pollo, las verduras y el aguacate al centro.',
      'Agrega un poco de yogurt natural o aderezo ligero.',
      'Enrolla el wrap y sirve.',
    ],
  ...
  },
  {
    ...
    description: 'Receta fresca con garbanzos, pepino, tomate y un toque de limon.',
    calories: 0,
    proteinGrams: 0,
    carbsGrams: 0,
    fatGrams: 0,
    ...
    instructions: [
      'Mezcla los garbanzos con las verduras picadas.',
      'Agrega limon, aceite de oliva y sal al gusto.',
      'Refrigera unos minutos antes de servir si la prefieres fresca.',
    ],
  ...
  },
  {
    ...
    description: 'Desayuno o snack sencillo con fruta, yogurt natural y semillas.',
    calories: 0,
    proteinGrams: 0,
    carbsGrams: 0,
    fatGrams: 0,
    ...
    instructions: [
      ...
      'Agrega la fruta picada, avena y semillas.',
      'Termina con un poco de canela.',
    ],
    goals: ['maintain', 'improve_health', 'lose_weight'],
  },
  {
    ...
    description: 'Omelette rapido con huevo y verduras para una comida completa.',
    calories: 0,
    proteinGrams: 0,
    carbsGrams: 0,
    fatGrams: 0,
    ...
    instructions: [
      ...
      'Agrega el huevo batido y cocina a fuego medio.',
      'Dobla el omelette y sirve con queso fresco.',
    ],
    goals: ['maintain', 'improve_health', 'gain_muscle'],
  },
];
